...
static __attribute__((noinline)) void sort_01v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    sort_01v_ascending(d01);
    _mm256_storeu_ps((float *) ptr + 0, d01);
}

static __attribute__((noinline)) void sort_02v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
...
static __attribute__((noinline)) void sort_03v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
...
static __attribute__((noinline)) void sort_04v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
...
static __attribute__((noinline)) void sort_05v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_06v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_07v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_08v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_09v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_10v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_11v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_12v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_13v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_14v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_15v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
...
static __attribute__((noinline)) void sort_16v(float *ptr) {
    __m256 d01 = _mm256_loadu_ps((float const *) ptr + 0);
    __m256 d02 = _mm256_loadu_ps((float const *) ptr + 1);
    __m256 d03 = _mm256_loadu_ps((float const *) ptr + 2);
    __m256 d04 = _mm256_loadu_ps((float const *) ptr + 3);
    ...
    static void sort(float *ptr, int length) {
    const int N = 8;
