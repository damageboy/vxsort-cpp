...
struct BitonicMachineAVX2_u16   : public SortTest<u16> {};
struct BitonicMachineAVX2_i32    : public SortTest<i32> {};
struct BitonicMachineAVX2_u32   : public SortTest<uint32> {};
struct BitonicMachineAVX2_float  : public SortTest<f32> {};
struct BitonicMachineAVX2_i64    : public SortTest<i64> {};
struct BitonicMachineAVX2_u64   : public SortTest<u64> {};
...
//TEST_P(BitonicAVX2_u32, BitonicSortAVX2) { perform_bitonic_sort_test<u32, VM::AVX2>(V); }
//TEST_P(BitonicAVX2_i64, BitonicSortAVX2) { perform_bitonic_sort_test<i64, VM::AVX2>(V); }
//TEST_P(BitonicAVX2_u64, BitonicSortAVX2) { perform_bitonic_sort_test<u64, VM::AVX2>(V); }
//TEST_P(BitonicAVX2_f32, BitonicSortAVX2) { perform_bitonic_sort_test<f32, VM::AVX2>(V); }
//TEST_P(BitonicAVX2_f64, BitonicSortAVX2) { perform_bitonic_sort_test<f64, VM::AVX2>(V); }
