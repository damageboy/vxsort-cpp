...
TEST_P(BitonicMachineAVX512_i32,    BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<int32_t,  VM::AVX512, true>(V); }
TEST_P(BitonicMachineAVX512_ui32,   BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<uint32_t, VM::AVX512, true>(V); }
TEST_P(BitonicMachineAVX512_float,  BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<float,    VM::AVX512, true>(V); }
TEST_P(BitonicMachineAVX512_i64,    BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<int64_t,  VM::AVX512, true>(V); }
TEST_P(BitonicMachineAVX512_ui64,   BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<uint64_t, VM::AVX512, true>(V); }
TEST_P(BitonicMachineAVX512_double, BitonicSortAVX2Asc) { perform_bitonic_machine_sort_test<double,   VM::AVX512, true>(V); }
