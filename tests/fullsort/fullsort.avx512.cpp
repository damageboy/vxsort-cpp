...
auto vxsort_values_avx512_32 = ValuesIn(SizeAndSlack::generate(10, 1000000, 10, 32));
auto vxsort_values_avx512_64 = ValuesIn(SizeAndSlack::generate(10, 1000000, 10, 16));

INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_i32,    vxsort_values_avx512_32, PrintSizeAndSlack());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_ui32,   vxsort_values_avx512_32, PrintSizeAndSlack());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_float,  vxsort_values_avx512_64, PrintSizeAndSlack());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_i64,    vxsort_values_avx512_64, PrintSizeAndSlack());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_ui64,   vxsort_values_avx512_64, PrintSizeAndSlack());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX512_double, vxsort_values_avx512_64, PrintSizeAndSlack());
