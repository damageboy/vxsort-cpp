...
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_1)  { perform_vxsort_test<u32,  1, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_2)  { perform_vxsort_test<u32,  2, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_4)  { perform_vxsort_test<u32,  4, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_8)  { perform_vxsort_test<u32,  8, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_12) { perform_vxsort_test<u32, 12, vector_machine::AVX2>(V); }

TEST_P(FullSortTestAVX2_f32, VxSortAVX2_1)  { perform_vxsort_test<f32,  1, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_2)  { perform_vxsort_test<f32,  2, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_4)  { perform_vxsort_test<f32,  4, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_8)  { perform_vxsort_test<f32,  8, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_12) { perform_vxsort_test<f32, 12, vector_machine::AVX2>(V); }
...
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_1)  { perform_vxsort_test<u64,  1, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_2)  { perform_vxsort_test<u64,  2, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_4)  { perform_vxsort_test<u64,  4, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_8)  { perform_vxsort_test<u64,  8, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_12) { perform_vxsort_test<u64, 12, vector_machine::AVX2>(V); }

TEST_P(FullSortTestAVX2_f64, VxSortAVX2_1)  { perform_vxsort_test<f64,  1, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_2)  { perform_vxsort_test<f64,  2, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_4)  { perform_vxsort_test<f64,  4, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_8)  { perform_vxsort_test<f64,  8, vector_machine::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_12) { perform_vxsort_test<f64, 12, vector_machine::AVX2>(V); }
