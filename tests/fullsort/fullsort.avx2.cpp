...
struct FullSortTestAVX2_i16 : public SortWithSlackTest<i16> {};
struct FullSortTestAVX2_i32 : public SortWithSlackTest<i32> {};
struct FullSortTestAVX2_u16 : public SortWithSlackTest<u16> {};
...
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX2_i16, vxsort_i16_params_avx2, PrintSizeAndSlack<i16>());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX2_i32, vxsort_i32_params_avx2, PrintSizeAndSlack<i32>());
INSTANTIATE_TEST_SUITE_P(FullSort, FullSortTestAVX2_u16, vxsort_u16_params_avx2, PrintSizeAndSlack<u16>());
...
TEST_P(FullSortTestAVX2_i32, VxSortAVX2_4)  { vxsort_test<i32,  4, VMT::AVX2>(V); }
...
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_4)  { vxsort_test<u32,  4, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_8)  { vxsort_test<u32,  8, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u32, VxSortAVX2_12) { vxsort_test<u32, 12, VMT::AVX2>(V); }

TEST_P(FullSortTestAVX2_f32, VxSortAVX2_1)  { vxsort_test<f32,  1, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_2)  { vxsort_test<f32,  2, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_4)  { vxsort_test<f32,  4, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_8)  { vxsort_test<f32,  8, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f32, VxSortAVX2_12) { vxsort_test<f32, 12, VMT::AVX2>(V); }

TEST_P(FullSortTestAVX2_i64, VxSortAVX2_1)  { vxsort_test<i64,  1, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_i64, VxSortAVX2_2)  { vxsort_test<i64,  2, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_i64, VxSortAVX2_4)  { vxsort_test<i64,  4, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_i64, VxSortAVX2_8)  { vxsort_test<i64,  8, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_i64, VxSortAVX2_12) { vxsort_test<i64, 12, VMT::AVX2>(V); }

TEST_P(FullSortTestAVX2_u64, VxSortAVX2_1)  { vxsort_test<u64,  1, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_2)  { vxsort_test<u64,  2, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_4)  { vxsort_test<u64,  4, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_8)  { vxsort_test<u64,  8, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_u64, VxSortAVX2_12) { vxsort_test<u64, 12, VMT::AVX2>(V); }

TEST_P(FullSortTestAVX2_f64, VxSortAVX2_1)  { vxsort_test<f64,  1, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_2)  { vxsort_test<f64,  2, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_4)  { vxsort_test<f64,  4, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_8)  { vxsort_test<f64,  8, VMT::AVX2>(V); }
TEST_P(FullSortTestAVX2_f64, VxSortAVX2_12) { vxsort_test<f64, 12, VMT::AVX2>(V); }
...
TEST_P(FullSortStridedTestAVX2_i64, VxSortStridedAVX2_1)  { vxsort_hinted_test<i64,  1, 3, VMT::AVX2>(V, MinValue, MaxValue); }
TEST_P(FullSortStridedTestAVX2_i64, VxSortStridedAVX2_2)  { vxsort_hinted_test<i64,  2, 3, VMT::AVX2>(V, MinValue, MaxValue); }
TEST_P(FullSortStridedTestAVX2_i64, VxSortStridedAVX2_4)  { vxsort_hinted_test<i64,  4, 3, VMT::AVX2>(V, MinValue, MaxValue); }
TEST_P(FullSortStridedTestAVX2_i64, VxSortStridedAVX2_8)  { vxsort_hinted_test<i64,  8, 3, VMT::AVX2>(V, MinValue, MaxValue); }
TEST_P(FullSortStridedTestAVX2_i64, VxSortStridedAVX2_12) { vxsort_hinted_test<i64, 12, 3, VMT::AVX2>(V, MinValue, MaxValue); }
