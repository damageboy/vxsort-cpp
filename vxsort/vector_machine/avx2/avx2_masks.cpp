...
alignas(16) const u8 prefix_mask_table_64b[M4_SIZE] = {
...
alignas(16) const u8 suffix_mask_table_64b[M4_SIZE] = {
        0xFF, 0xFF, 0xFF, 0xFF,  // 0b0000 (0)
        0x00, 0xFF, 0xFF, 0xFF,  // 0b1110 (7)
        0x00, 0x00, 0xFF, 0xFF,  // 0b1100 (3)
        0x00, 0x00, 0x00, 0xFF,  // 0b1000 (1)
        0xFF, 0xFF, 0xFF, 0xFF,  // 0b0000 (0)
        /////////////////////////// Garbage to make ASAN happy
        0xCC, 0xCC, 0xCC, 0xCC,  // Garbage to make ASAN happy
        0xCC, 0xCC, 0xCC, 0xCC,  // Garbage to make ASAN happy
...
alignas(128) const u8 prefix_mask_table_32b[M8_SIZE] = {// MSB    LSB
...
alignas(128) const u8 suffix_mask_table_32b[M8_SIZE] = {// MSB    LSB
        0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, // 0b00000000 (  0)
