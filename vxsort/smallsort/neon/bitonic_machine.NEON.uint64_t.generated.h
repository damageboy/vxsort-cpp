...
#ifndef BITONIC_MACHINE_NEON_UINT64_T_H
#define BITONIC_MACHINE_NEON_UINT64_T_H
...
public:
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(uint64_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(uint64_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
