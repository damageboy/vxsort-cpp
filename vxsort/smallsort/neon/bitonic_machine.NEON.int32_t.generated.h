...
#ifndef BITONIC_MACHINE_NEON_INT32_T_H
#define BITONIC_MACHINE_NEON_INT32_T_H
...
template<> struct bitonic_machine<int32_t, AVX2> {
    static const int N = 8;
    static constexpr int32_t MAX = std::numeric_limits<int32_t>::max();
public:
    typedef int32x4_t TV;
    typedef int32x4_t TMASK;
    ...
    static INLINE void sort_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d02;
        d02 = vmaxq_s32(d01, d02);
        d01 = vminq_s32(d01, tmp);
    ...
    static INLINE void merge_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d01;
        d01 = vminq_s32(d02, d01);
        d02 = vmaxq_s32(d02, tmp);
    ...
    static INLINE void sort_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d03;
        d03 = vmaxq_s32(d02, d03);
        d02 = vminq_s32(d02, tmp);
    ...
    static INLINE void merge_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d01;
        d01 = vminq_s32(d03, d01);
        d03 = vmaxq_s32(d03, tmp);
    ...
    static INLINE void merge_04v_ascending(TV& d01, TV& d02, TV& d03, TV& d04) {
        ...
        tmp = d02;
        d02 = vminq_s32(d04, d02);
        d04 = vmaxq_s32(d04, tmp);
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(int32_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(int32_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
