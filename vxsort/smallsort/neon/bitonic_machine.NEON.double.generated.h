...
#ifndef BITONIC_MACHINE_NEON_DOUBLE_H
#define BITONIC_MACHINE_NEON_DOUBLE_H
...
template<> struct bitonic_machine<double, AVX2> {
    static const int N = 4;
    static constexpr double MAX = std::numeric_limits<double>::max();
public:
    typedef float64x2_t TV;
    typedef float64x2_t TMASK;
    ...
    static NOINLINE void sort_01v_full_ascending(double *ptr) {
        TV d01 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 0));
        sort_01v_ascending(d01);
    ...
    static NOINLINE void sort_02v_full_ascending(double *ptr) {
        TV d01 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 0));
        TV d02 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 1));
        sort_02v_ascending(d01, d02);
        _mm256_storeu_pd((double *) ((__m256d *)  ptr + 0), d01);
    ...
    static NOINLINE void sort_03v_full_ascending(double *ptr) {
        TV d01 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 0));
        TV d02 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 1));
        TV d03 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 2));
    ...
    static NOINLINE void sort_04v_full_ascending(double *ptr) {
        ...
        TV d02 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 1));
        TV d03 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 2));
        TV d04 = _mm256_loadu_pd((double const *) ((__m256d const *) ptr + 3));
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(double *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(double *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
