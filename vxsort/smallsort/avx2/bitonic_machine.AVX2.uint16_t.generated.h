...
#ifndef BITONIC_MACHINE_AVX2_UINT16_T_H
#define BITONIC_MACHINE_AVX2_UINT16_T_H
...
template<> struct bitonic_machine<uint16_t, AVX2> {
...
public:
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        TV min, max, s;
        const TV x1 = _mm256_set_epi64x(0xD0C0F0E09080B0A, 0x504070601000302, 0xD0C0F0E09080B0A, 0x504070601000302);
        const TV x1_blend = _mm256_set_epi64x(0x808000008080, 0x808000008080, 0x8080000080800000, 0x8080000080800000);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b01100110);

        s = _mm256_shuffle_epi32(d01, 0b10'11'00'01);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b00111100);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b01011010);
        ...
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blendv_epi8(min, max, x1_blend);
        ...
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b11110000);

        s = _mm256_shuffle_epi32(d01, 0b10'11'00'01);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b11001100);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b10101010);
    }
    ...
    static INLINE void sort_01v_descending(TV& d01) {
        TV min, max, s;
        const TV x1 = _mm256_set_epi64x(0xD0C0F0E09080B0A, 0x504070601000302, 0xD0C0F0E09080B0A, 0x504070601000302);
        const TV x1_blend = _mm256_set_epi64x(0x8080000080800000, 0x8080000080800000, 0x808000008080, 0x808000008080);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b10011001);

        s = _mm256_shuffle_epi32(d01, 0b10'11'00'01);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b11000011);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b10100101);
        ...
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b00001111);

        s = _mm256_shuffle_epi32(d01, 0b10'11'00'01);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b00110011);

        s = _mm256_shuffle_epi8(d01, x1);
        min = _mm256_min_epu16(s, d01);
        max = _mm256_max_epu16(s, d01);
        d01 = _mm256_blend_epi16(min, max, 0b01010101);
    }
    ...
    static INLINE void sort_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d02;
        d02 = _mm256_max_epu16(d01, d02);
        d01 = _mm256_min_epu16(d01, tmp);
    ...
    static INLINE void merge_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d01;
        d01 = _mm256_min_epu16(d02, d01);
        d02 = _mm256_max_epu16(d02, tmp);
    ...
    static INLINE void sort_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d03;
        d03 = _mm256_max_epu16(d02, d03);
        d02 = _mm256_min_epu16(d02, tmp);
    ...
    static INLINE void merge_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d01;
        d01 = _mm256_min_epu16(d03, d01);
        d03 = _mm256_max_epu16(d03, tmp);
    ...
    static INLINE void merge_04v_ascending(TV& d01, TV& d02, TV& d03, TV& d04) {
        ...
        tmp = d02;
        d02 = _mm256_min_epu16(d04, d02);
        d04 = _mm256_max_epu16(d04, tmp);
    ...
    static INLINE void cross_min_max(TV& d01, TV& d02) {
        ...
        tmp = d2i(_mm256_permute4x64_pd(i2d(_mm256_shuffle_epi32(_mm256_shuffle_epi8(d02, x1), 0b00'01'10'11)), 0b01'00'11'10));
        d02 = _mm256_max_epu16(d01, tmp);        
        d01 = _mm256_min_epu16(d01, tmp);
    }
    static INLINE void strided_min_max(TV& dl, TV& dr) {
        ...
        tmp = dl;
        dl = _mm256_min_epu16(dr, dl);
        dr = _mm256_max_epu16(dr, tmp);
    }

#ifdef BITONIC_TESTS

    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_ascending(uint16_t *ptr) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_ascending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        TV d02 = _mm256_lddqu_si256((__m256i const *) ptr + 1);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_ascending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        TV d02 = _mm256_lddqu_si256((__m256i const *) ptr + 1);;
        TV d03 = _mm256_lddqu_si256((__m256i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_descending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        sort_01v_descending(d01);
        _mm256_storeu_si256((__m256i *) ptr + 0, d01);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_descending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        TV d02 = _mm256_lddqu_si256((__m256i const *) ptr + 1);;
        sort_02v_descending(d01, d02);
        _mm256_storeu_si256((__m256i *) ptr + 0, d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_descending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        TV d02 = _mm256_lddqu_si256((__m256i const *) ptr + 1);;
        TV d03 = _mm256_lddqu_si256((__m256i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_descending(uint16_t *ptr) {
        TV d01 = _mm256_lddqu_si256((__m256i const *) ptr + 0);;
        TV d02 = _mm256_lddqu_si256((__m256i const *) ptr + 1);;
        TV d03 = _mm256_lddqu_si256((__m256i const *) ptr + 2);;
        TV d04 = _mm256_lddqu_si256((__m256i const *) ptr + 3);;
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(uint16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(uint16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
