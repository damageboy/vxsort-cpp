...
#ifndef BITONIC_MACHINE_AVX2_F32_H
#define BITONIC_MACHINE_AVX2_F32_H
...
template<> struct bitonic_machine<f32, AVX2> {
...
public:
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        ...
        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b10'11'00'01));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b01100110));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b00111100));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b10'11'00'01));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b01011010));

        s = d2s(_mm256_permute4x64_pd(s2d(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b11110000));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b11001100));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b10'11'00'01));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b10101010));
    }
    ...
    static INLINE void sort_01v_descending(TV& d01) {
        ...
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b10011001));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b11000011));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b10'11'00'01));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b10100101));

        s = d2s(_mm256_permute4x64_pd(s2d(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b00001111));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b01'00'11'10));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b00110011));

        s = i2s(_mm256_shuffle_epi32(s2i(d01), 0b10'11'00'01));
        min = _mm256_min_ps(s, d01);
        max = _mm256_max_ps(s, d01);
        d01 = i2s(_mm256_blend_epi32(s2i(min), s2i(max), 0b01010101));
    }
    ...
    static INLINE void cross_min_max(TV& d01, TV& d02) {
        ...
        tmp = d2s(_mm256_permute4x64_pd(i2d(_mm256_shuffle_epi32(s2i(d02), 0b00'01'10'11)), 0b01'00'11'10));
    ...
    static NOINLINE void sort_01v_full_ascending(f32 *ptr) {
        TV d01 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 0));
        sort_01v_ascending(d01);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 0), d01);
    }

    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(f32 *ptr) {
        TV d01 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 0));
        TV d02 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 1));
        sort_02v_ascending(d01, d02);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 0), d01);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 1), d02);
    }
    ...
    static NOINLINE void sort_03v_full_ascending(f32 *ptr) {
        TV d01 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 0));
        TV d02 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 1));
        TV d03 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 2));
        sort_03v_ascending(d01, d02, d03);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 0), d01);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 1), d02);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 2), d03);
    }
    ...
    static NOINLINE void sort_04v_full_ascending(f32 *ptr) {
        ...
        TV d02 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 1));
        TV d03 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 2));
        TV d04 = _mm256_loadu_ps((f32 const *) ((__m256 const *) ptr + 3));
        sort_04v_ascending(d01, d02, d03, d04);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 0), d01);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 1), d02);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 2), d03);
        _mm256_storeu_ps((f32 *) ((__m256 *)  ptr + 3), d04);
    }
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(f32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(f32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
