...
#ifndef BITONIC_MACHINE_AVX2_INT16_T_H
#define BITONIC_MACHINE_AVX2_INT16_T_H
...
template<> struct bitonic_machine<int16_t, AVX2> {
...
public:
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        ...
        min = _mm256_min_epi16(s, d01);
        max = _mm256_max_epi16(s, d01);
    ...
    static INLINE void sort_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d02;
        d02 = _mm256_max_epi16(d01, d02);
        d01 = _mm256_min_epi16(d01, tmp);
    ...
    static INLINE void merge_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d01;
        d01 = _mm256_min_epi16(d02, d01);
        d02 = _mm256_max_epi16(d02, tmp);
    ...
    static INLINE void sort_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d03;
        d03 = _mm256_max_epi16(d02, d03);
        d02 = _mm256_min_epi16(d02, tmp);
    ...
    static INLINE void merge_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d01;
        d01 = _mm256_min_epi16(d03, d01);
        d03 = _mm256_max_epi16(d03, tmp);
    ...
    static INLINE void merge_04v_ascending(TV& d01, TV& d02, TV& d03, TV& d04) {
        ...
        tmp = d02;
        d02 = _mm256_min_epi16(d04, d02);
        d04 = _mm256_max_epi16(d04, tmp);
    ...
    static INLINE void strided_min_max(TV& dl, TV& dr) {
        ...
        tmp = dl;
        dl = _mm256_min_epi16(dr, dl);
        dr = _mm256_max_epi16(dr, tmp);
    }
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(int16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(int16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
