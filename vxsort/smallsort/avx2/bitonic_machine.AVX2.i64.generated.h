...
#ifndef BITONIC_MACHINE_AVX2_I64_H
#define BITONIC_MACHINE_AVX2_I64_H
...
template<> struct bitonic_machine<i64, AVX2> {
...
public:
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(i64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(i64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
