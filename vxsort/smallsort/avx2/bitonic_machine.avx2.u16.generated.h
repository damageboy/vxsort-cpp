...
#ifndef BITONIC_MACHINE_AVX2_U16_H
#define BITONIC_MACHINE_AVX2_U16_H
...
template<> struct bitonic_machine<u16, AVX2> {
...
public:
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(u16 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(u16 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
