...
#ifndef BITONIC_MACHINE_AVX2_U32_H
#define BITONIC_MACHINE_AVX2_U32_H
...
template<> struct bitonic_machine<u32, AVX2> {
...
public:
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_ascending(u32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static void sort_full_vectors_descending(u32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
