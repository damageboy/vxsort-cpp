#include "bitonic_sort.AVX2.float.generated.h"

using namespace vxsort;

void vxsort::smallsort::bitonic<float, vector_machine::AVX2 >::sort(float *ptr, size_t length) {
    switch(length / N) {
...
void vxsort::smallsort::bitonic<float, vector_machine::AVX2 >::sort_alt(float *ptr, size_t length) {
