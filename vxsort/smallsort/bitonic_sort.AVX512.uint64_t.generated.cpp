...
void vxsort::smallsort::bitonic<uint64_t, vector_machine::AVX512 >::sort(uint64_t *ptr, size_t length) {
    switch(length / N) {
...
void vxsort::smallsort::bitonic<uint64_t, vector_machine::AVX512 >::sort_alt(uint64_t *ptr, size_t length) {
