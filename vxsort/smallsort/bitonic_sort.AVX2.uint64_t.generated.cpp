#include "bitonic_sort.AVX2.uint64_t.generated.h"

using namespace vxsort;

void vxsort::smallsort::bitonic<uint64_t, vector_machine::AVX2 >::sort(uint64_t *ptr, size_t length) {
    switch(length / N) {
...
void vxsort::smallsort::bitonic<uint64_t, vector_machine::AVX2 >::sort_alt(uint64_t *ptr, size_t length) {
