...
class NeonBitonicISA(BitonicISA):
    ...
    def clean_print(self, s: str):
        clean_lines = str.join("\n", [l for l in s.splitlines() if not NeonBitonicISA.REMOVE_ME in l])
    ...
    def generate_shuffle_X1(self, v: str):
        ...
        if size == 16:
            ...
            return self.i2t(f"vrev64q_s32({self.t2i(v)})")
        elif size == 4:
...
#ifndef BITONIC_MACHINE_NEON_{t.upper()}_H
#define BITONIC_MACHINE_NEON_{t.upper()}_H
