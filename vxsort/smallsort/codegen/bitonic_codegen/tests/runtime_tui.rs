...
use bitonic_codegen::runtime::{RuntimeEvent, ScoringProgressSnapshot, StageProgressSnapshot};
use bitonic_codegen::runtime_tui::{
...
use bitonic_codegen::transition_table::StageStats;
