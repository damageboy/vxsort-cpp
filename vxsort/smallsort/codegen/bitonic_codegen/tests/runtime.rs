...
use bitonic_codegen::runtime::{ChannelRuntimeSession, RuntimeEvent, RuntimeSession};
use bitonic_codegen::runtime_trace::RuntimeTrace;
...
fn runtime_trace_records_worker_jobs_and_counters() {
    ...
    {
        let trace = RuntimeTrace::open(&trace_path).expect("trace file should open");
