...
public:
    ...
    static NOINLINE void sort_01v_full_ascending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        sort_01v_ascending(d01);
        _mm512_storeu_ps((float *) ((__m512 *)  ptr + 0), d01);
    }

    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        sort_02v_ascending(d01, d02);
        _mm512_storeu_ps((float *) ((__m512 *)  ptr + 0), d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_ascending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        TV d03 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 2));
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_ascending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        TV d03 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 2));
        TV d04 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 3));
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_descending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        sort_01v_descending(d01);
        _mm512_storeu_ps((float *) ((__m512 *)  ptr + 0), d01);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_descending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        sort_02v_descending(d01, d02);
        _mm512_storeu_ps((float *) ((__m512 *)  ptr + 0), d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_descending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        TV d03 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 2));
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_descending(float *ptr) {
        TV d01 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 0));
        TV d02 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 1));
        TV d03 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 2));
        TV d04 = _mm512_loadu_ps((float const *) ((__m512 const *) ptr + 3));
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(float *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(float *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
