...
#ifndef BITONIC_MACHINE_AVX512_UINT16_T_H
#define BITONIC_MACHINE_AVX512_UINT16_T_H
...
namespace vxsort {
namespace smallsort {
template<> struct bitonic_machine<uint16_t, AVX512> {
...
public:
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(uint16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(uint16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
