...
#ifndef BITONIC_MACHINE_AVX512_UINT32_T_H
#define BITONIC_MACHINE_AVX512_UINT32_T_H
...
namespace vxsort {
namespace smallsort {
template<> struct bitonic_machine<uint32_t, AVX512> {
...
public:
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        ...
        d01 = _mm512_mask_max_epu32(min, 0b0110011001100110, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0011110000111100, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0101101001011010, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0000111111110000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0011001111001100, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0101010110101010, s, d01);

        s = _mm512_shuffle_i64x2(d01, d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1111111100000000, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1111000011110000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1100110011001100, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1010101010101010, s, d01);
    }
    ...
    static INLINE void sort_01v_descending(TV& d01) {
        ...
        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1001100110011001, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1100001111000011, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1010010110100101, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1111000000001111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1100110000110011, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b1010101001010101, s, d01);

        s = _mm512_shuffle_i64x2(d01, d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0000000011111111, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0000111100001111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0011001100110011, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epu32(s, d01);
        d01 = _mm512_mask_max_epu32(min, 0b0101010101010101, s, d01);
    }
    ...
    static NOINLINE void sort_01v_full_ascending(uint32_t *ptr) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_ascending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_ascending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_descending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        sort_01v_descending(d01);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_descending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        sort_02v_descending(d01, d02);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_descending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_descending(uint32_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
        TV d04 = _mm512_loadu_si512((__m512i const *) ptr + 3);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(uint32_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(uint32_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
