...
#ifndef BITONIC_MACHINE_AVX512_I32_H
#define BITONIC_MACHINE_AVX512_I32_H
...
template<> struct bitonic_machine<i32, AVX512> {
...
public:
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(i32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(i32 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
