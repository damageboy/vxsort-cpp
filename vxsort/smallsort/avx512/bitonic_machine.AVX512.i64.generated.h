...
#ifndef BITONIC_MACHINE_AVX512_I64_H
#define BITONIC_MACHINE_AVX512_I64_H
...
template<> struct bitonic_machine<i64, AVX512> {
    static const int N = 8;
    static constexpr i64 MAX = std::numeric_limits<i64>::max();
public:
    typedef __m512i TV;
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        ...
        d01 = _mm512_mask_max_epi64(min, 0b01100110, s, d01);

        s = d2i(_mm512_permutex_pd(i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b00111100, s, d01);

        s = d2i(_mm512_permute_pd(i2d(d01), (_MM_PERM_ENUM) 0b0'1'0'1'0'1'0'1));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b01011010, s, d01);

        s = d2i(_mm512_shuffle_f64x2(i2d(d01), i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b11110000, s, d01);

        s = d2i(_mm512_permutex_pd(i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b11001100, s, d01);

        s = d2i(_mm512_permute_pd(i2d(d01), (_MM_PERM_ENUM) 0b0'1'0'1'0'1'0'1));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b10101010, s, d01);
    }
    ...
    static INLINE void sort_01v_descending(TV& d01) {
        ...
        s = d2i(_mm512_permute_pd(i2d(d01), (_MM_PERM_ENUM) 0b0'1'0'1'0'1'0'1));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b10011001, s, d01);

        s = d2i(_mm512_permutex_pd(i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b11000011, s, d01);

        s = d2i(_mm512_permute_pd(i2d(d01), (_MM_PERM_ENUM) 0b0'1'0'1'0'1'0'1));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b10100101, s, d01);

        s = d2i(_mm512_shuffle_f64x2(i2d(d01), i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b00001111, s, d01);

        s = d2i(_mm512_permutex_pd(i2d(d01), (_MM_PERM_ENUM) 0b01'00'11'10));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b00110011, s, d01);

        s = d2i(_mm512_permute_pd(i2d(d01), (_MM_PERM_ENUM) 0b0'1'0'1'0'1'0'1));
        min = _mm512_min_epi64(s, d01);
        d01 = _mm512_mask_max_epi64(min, 0b01010101, s, d01);
    }
    ...
    static NOINLINE void sort_01v_full_ascending(i64 *ptr) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_ascending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_ascending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_descending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        sort_01v_descending(d01);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_descending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        sort_02v_descending(d01, d02);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_descending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_descending(i64 *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
        TV d04 = _mm512_loadu_si512((__m512i const *) ptr + 3);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(i64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(i64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
