/////////////////////////////////////////////////////////////////////////////
////
// This file was auto-generated by a tool at 2021-04-22 20:57:03
//
// It is recommended you DO NOT directly edit this file but instead edit
// the code-generator that generated this source file instead.
/////////////////////////////////////////////////////////////////////////////

#ifndef BITONIC_MACHINE_AVX512_INT16_T_H
#define BITONIC_MACHINE_AVX512_INT16_T_H
...
namespace vxsort {
namespace smallsort {
template<> struct bitonic_machine<int16_t, AVX512> {
...
public:
    ...
    static INLINE void sort_01v_ascending(TV& d01) {
        ...
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b01100110011001100110011001100110, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00111100001111000011110000111100, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b01011010010110100101101001011010, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00001111111100000000111111110000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00110011110011000011001111001100, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b01010101101010100101010110101010, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00000000111111111111111100000000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00001111000011111111000011110000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00110011001100111100110011001100, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b01010101010101011010101010101010, s, d01);

        s = _mm512_shuffle_i64x2(d01, d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11111111111111110000000000000000, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11111111000000001111111100000000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11110000111100001111000011110000, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11001100110011001100110011001100, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b10101010101010101010101010101010, s, d01);
    }
    ...
    static INLINE void sort_01v_descending(TV& d01) {
        ...
        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b10011001100110011001100110011001, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11000011110000111100001111000011, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b10100101101001011010010110100101, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11110000000011111111000000001111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11001100001100111100110000110011, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b10101010010101011010101001010101, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11111111000000000000000011111111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11110000111100000000111100001111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b11001100110011000011001100110011, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b10101010101010100101010101010101, s, d01);

        s = _mm512_shuffle_i64x2(d01, d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00000000000000001111111111111111, s, d01);

        s = _mm512_permutex_epi64(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00000000111111110000000011111111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM) 0b01'00'11'10);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00001111000011110000111100001111, s, d01);

        s = _mm512_shuffle_epi32(d01, (_MM_PERM_ENUM)  0b10'11'00'01);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b00110011001100110011001100110011, s, d01);

        s = _mm512_shuffle_epi8(d01, x1);
        min = _mm512_min_epi16(s, d01);
        d01 = _mm512_mask_max_epi16(min, 0b01010101010101010101010101010101, s, d01);
    }
    ...
    static INLINE void sort_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d02;
        d02 = _mm512_max_epi16(d01, d02);
        d01 = _mm512_min_epi16(d01, tmp);
    ...
    static INLINE void merge_02v_ascending(TV& d01, TV& d02) {
        ...
        tmp = d01;
        d01 = _mm512_min_epi16(d02, d01);
        d02 = _mm512_max_epi16(d02, tmp);
    ...
    static INLINE void sort_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d03;
        d03 = _mm512_max_epi16(d02, d03);
        d02 = _mm512_min_epi16(d02, tmp);
    ...
    static INLINE void merge_03v_ascending(TV& d01, TV& d02, TV& d03) {
        ...
        tmp = d01;
        d01 = _mm512_min_epi16(d03, d01);
        d03 = _mm512_max_epi16(d03, tmp);
    ...
    static INLINE void merge_04v_ascending(TV& d01, TV& d02, TV& d03, TV& d04) {
        ...
        tmp = d02;
        d02 = _mm512_min_epi16(d04, d02);
        d04 = _mm512_max_epi16(d04, tmp);
    ...
    static NOINLINE void sort_01v_full_ascending(int16_t *ptr) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_ascending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_ascending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_01v_full_descending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        sort_01v_descending(d01);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_descending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        sort_02v_descending(d01, d02);
        _mm512_storeu_si512((__m512i *) ptr + 0, d01);
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_03v_full_descending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_04v_full_descending(int16_t *ptr) {
        TV d01 = _mm512_loadu_si512((__m512i const *) ptr + 0);;
        TV d02 = _mm512_loadu_si512((__m512i const *) ptr + 1);;
        TV d03 = _mm512_loadu_si512((__m512i const *) ptr + 2);;
        TV d04 = _mm512_loadu_si512((__m512i const *) ptr + 3);;
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(int16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(int16_t *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
