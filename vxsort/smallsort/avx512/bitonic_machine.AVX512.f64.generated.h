...
#ifndef BITONIC_MACHINE_AVX512_F64_H
#define BITONIC_MACHINE_AVX512_F64_H
...
template<> struct bitonic_machine<f64, AVX512> {
...
public:
    ...
    static NOINLINE void sort_01v_full_ascending(f64 *ptr) {
        TV d01 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 0));
        sort_01v_ascending(d01);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 0), d01);
    }

    // This is generated for testing purposes only
    static NOINLINE void sort_02v_full_ascending(f64 *ptr) {
        TV d01 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 0));
        TV d02 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 1));
        sort_02v_ascending(d01, d02);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 0), d01);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 1), d02);
    }
    ...
    static NOINLINE void sort_03v_full_ascending(f64 *ptr) {
        TV d01 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 0));
        TV d02 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 1));
        TV d03 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 2));
        sort_03v_ascending(d01, d02, d03);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 0), d01);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 1), d02);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 2), d03);
    }
    ...
    static NOINLINE void sort_04v_full_ascending(f64 *ptr) {
        ...
        TV d02 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 1));
        TV d03 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 2));
        TV d04 = _mm512_loadu_pd((f64 const *) ((__m512d const *) ptr + 3));
        sort_04v_ascending(d01, d02, d03, d04);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 0), d01);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 1), d02);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 2), d03);
        _mm512_storeu_pd((f64 *) ((__m512d *)  ptr + 3), d04);
    }
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_ascending(f64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
    ...
    // This is generated for testing purposes only
    static NOINLINE void sort_full_vectors_descending(f64 *ptr, size_t length) {
        assert(length % N == 0);
        switch(length / N) {
